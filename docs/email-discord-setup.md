...
Address shape (K4, decided 2026-07-05): plus-alias `you+pkms@example.com`
...
1. Gmail → Settings → Filters → Create filter: **To** `you+pkms@example.com`
...
3. In the repo root, create two files (gitignored under `.secrets/`):
   - `.secrets/email-address` — `you@example.com`
