...
| K8 | First `pkms ingest keep-takeout <zip>` after the Takeout ZIP lands | ~1 min | PKMS Keep onramp: ~200 existing notes land in vault/inbox/ with attachments mirrored to `<repo-root>/keep-media/`. |
