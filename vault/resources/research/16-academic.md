...
Merged findings from three academic research tracks: (1) executive-function scaffolding & assistive technology, (2) habit, motivation & shame, (3) retrieval & resurfacing. 29 findings; 9 sample-verified by an adversarial fact-checker, 5 failed quote-level verification (kept and flagged below — in every failed case the underlying claim held up, but the quoted text or its attribution did not).
...
8. **Treat interest/novelty frameworks and gamification as heuristics, not laws.** The "interest-based nervous system" is influential clinical observation, not validated science (MO6); gamification's benefit is real but modest and likely decays with age and novelty (MO10). Use bounded, unpredictable, user-pulled resurfacing for engagement (RT12) — and keep the core capture-and-retrieve loop intrinsically useful so value never depends on a points layer. Marketplace "ADHD features" carry no efficacy evidence at all (SC7).
...
### MO1. ⚠ UNVERIFIED: Habit formation is genuinely harder in ADHD because the pre-automatic phase of a habit relies on exactly the executive functions (working memory, time awareness, inhibition, consistent repetition) that ADHD impairs, so the common advice to "just make it a habit" targets the weakest link.

**Checker found:** the cited article exists and supports the general claim (early habit formation draws on executive functions; ADHD makes that early stage harder to sustain), but the quoted text below does not appear in the source — the phrases about "dopamine signaling" and "frontostriatal networks" are absent from the article, which uses only generic language about neurodevelopmental differences. Treat the quote as unreliable; the claim's direction is still supported.

> Habits depend on executive functions... In ADHD, these executive functions are impaired due to differences in brain development and dopamine signaling, particularly in frontostriatal networks. Once a habit is fully automated... it depends less on executive function. That early stage, when the behavior is still intentional and effortful, demands consistent executive function engagement that may be harder to sustain.
...
> Research on context stability shows that performing a behavior in the same setting, at the same time, increases automaticity over time... studies have shown that how long it takes to create a habit varies widely, ranging from 4 to 335 days.

- **Source:** [Building Habits With ADHD: Time it Takes & How to Succeed — ADDA](https://add.org/building-habits/)
- **Credibility:** ADDA (Attention Deficit Disorder Association) professionally-reviewed popular education, citing the Lally et al. automaticity research (the 18–254 day, median 66 day finding). Cue-context mechanism is solid behavioral science; ADHD-specific efficacy claims are extrapolated, not directly tested.
...
### MO7. ⚠ UNVERIFIED: Rejection-sensitive dysphoria (RSD) is a popular Dodson-coined clinical term for extreme pain from perceived rejection/criticism, but it is explicitly not an established research construct — the formal evidence base is fragmented, with no agreed measure and only tiny qualitative studies.

**Checker found:** the cited PMC article exists and matches the described study (5 ADHD undergraduates, focus groups, thematic analysis), but the quoted passage below does not appear in it — the article acknowledges limited research but does not contain the "not an established research construct" framing or the scoping-review sentence. The quote appears to originate elsewhere or be a paraphrase presented as verbatim. The claim's substance (RSD is real as lived experience, thin as a validated construct) remains a fair reading of the literature; the quote-to-source link is broken.

> Because RSD is not an established research construct, the evidence base is fragmented. A recent scoping review found that conceptualizations and operationalizations of rejection-related distress varied considerably, and no studies examined responses to criticism or evaluated interventions.
...
- **Credibility:** The cited qualitative study is very small (5 undergraduates, focus groups, thematic analysis) — illustrative not generalizable. RSD is real as a lived experience and clinically salient, thin as a validated construct. Report both — and see the quote caveat above.
...
### MO10. Gamified digital interventions produce a real but modest benefit for ADHD outcomes (g≈0.28), but the trials are short with no long-term follow-up, so the worry that gamification's pull fades once novelty wears off is neither confirmed nor refuted — and efficacy appears to drop with age.

> a modest therapeutic effect of identified gamified DMHIs on ADHD outcomes compared to control conditions (g, 0.28; 95% CI, 0.09 to 0.48)... gamification's efficacy decreases in adolescents, potentially due to... compensatory strategies and ceiling effects.
...
### MO12. ⚠ UNVERIFIED: The "four motivators" map cleanly onto the user's own reported profile (surviving tools were zero-friction dumps; systems died when organizing outpaced capture), reinforcing that motivation, not capability, gates ADHD productivity — and that the engagement trigger is "if I can get started/engaged, I can do anything."

**Checker found:** the ADDitude article exists and substantively supports the claim — the four motivators are present and the engagement theme is clearly there — but the quote below is not verbatim. The phrase "If I can get engaged, I can do anything" does not appear; the closest source text is "if they get engaged with a task, they can do it," and the mundane-tasks framing is a paraphrase presented as a direct quote. The design implication remains well-supported by the article's actual content.

> ADHD brains are readily able to initiate and maintain focus on tasks that are interesting to them, which is why everyday mundane tasks can be difficult to initiate and complete... "If I can get engaged, I can do anything."

- **Source:** [Secrets of Your ADHD Brain — William Dodson, M.D. (ADDitude)](https://www.additudemag.com/secrets-of-the-adhd-brain/)
- **Credibility:** Clinical-observation source (see MO6 credibility caveat). Included because it directly converges with the user's questionnaire signals (task-initiation as #1 struggle; organizing effort killing systems) and Barkley's performance-not-knowledge model — triangulation across three independent framings raises confidence in the design direction even if the specific framework is unvalidated. See quote caveat above.
...
### RT7. ⚠ UNVERIFIED: The scheduled "weekly review" ritual (GTD's keystone) is, for ADHD, simultaneously the most valuable and the hardest-to-sustain habit — it reliably lapses, after which the system rots into a graveyard of stale items.

**Checker found:** both attributed quotes are real and do exist on workbrighter.co, but on a different page (workbrighter.co/gtd-getting-started/) than the cited URL — the cited /gtd-adhd/ page mentions the weekly review only once in passing. The citation as written is wrong; the quotes are misattributed to the wrong page on the same site. The underlying claim remains credible-folklore-grade either way.

> For people with ADHD, the review habit is both the hardest part to maintain AND the most valuable in the GTD system... Without regular reviews, your system becomes a graveyard of outdated tasks and forgotten projects.

- **Source:** [Is the GTD System ADHD-Friendly? My Take After 10 Years of Using It — Work Brighter](https://workbrighter.co/gtd-adhd/) (quotes actually appear at workbrighter.co/gtd-getting-started/)
- **Credibility:** Practitioner blog (lived-experience + coaching), not academic. Consistent with RT2 (time-based prospective-memory failure explains why a SCHEDULED review lapses). Treat as credible folklore corroborated by mechanism.
...
### RT12. ⚠ UNVERIFIED: Unpredictable (variable-ratio/interval) rewards drive more persistent engagement than predictable ones — the same intermittent-reinforcement mechanic that makes feeds compulsive can make serendipitous note re-encounter sticky — but it is double-edged and can tip into compulsion.

**Checker found:** the first half of the quote is confirmed verbatim on the cited page, but the second half ("the unpredictable nature of rewards can lead to excessive and compulsive behavior") does not appear there in that phrasing — it is an accurate-in-spirit paraphrase of ideas the page discusses, presented as a direct quote. The underlying behavioral principle is textbook operant conditioning and stands regardless.

> Variable ratio schedules reward after an unpredictable number of actions—producing faster, more persistent behavior... the unpredictable nature of rewards can lead to excessive and compulsive behavior.
...
Nine findings sampled across the three tracks (three per track) by an adversarial fact-checker.
...
**Sampled — motivation track (0/3 verified on quote level; claims directionally supported in all three):**

- [unverified] MO1 — Source exists and supports the general claim, but the quoted text does not appear in it; the neuroscience terminology in the quote is absent from the article entirely.
- [unverified] MO7 — The PMC study exists and matches the described characteristics (5 undergraduates, focus groups, three themes), but the quoted passage about a scoping review and "not an established research construct" does not appear in the article.
- [unverified] MO12 — The ADDitude article exists and substantively supports the claim (four motivators present, engagement-unlocks-performance theme clear), but the quote is a paraphrase presented as verbatim; "If I can get engaged, I can do anything" does not appear in the article.

Checker's summary for this track: all three fail verbatim-quote verification; in each case the cited source exists and broadly supports the underlying claim and design implication, but the specific block-quoted text cannot be confirmed as appearing in the source. Treat motivation-track quotes (and by extension unsampled quotes in this track) with extra suspicion; the claims and design implications remain directionally sound.
...
- [unverified] RT7 — Both quotes are real and appear on workbrighter.co, but on /gtd-getting-started/ rather than the cited /gtd-adhd/ URL; the cited page contains neither statement. Misattributed citation, not a fabricated quote.
- [unverified] RT12 — First sentence of the composite quote confirmed verbatim on the cited page; the second sentence does not appear there in that form — accurate-in-spirit paraphrase presented as a direct quote.

**Overall:** 4/9 sampled findings fully verified, 5/9 failed at the quote/citation level. No sampled claim was found to be substantively false — every failure was a quote that doesn't appear in the cited source, appears on a different page, or is a paraphrase dressed as verbatim. Implication for synthesis: the design implications are usable as-is; do not re-quote any blockquote from this note (especially from the motivation track) without re-checking it against the primary source first.
